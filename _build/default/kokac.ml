(* Fichier principal du compilateur Koka *)
...
let () =
  ...
  if not (Filename.check_suffix !ifile ".kc") then begin
    eprintf "Le fichier d'entrée doit avoir l'extension .kc\n@?";
